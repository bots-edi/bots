...
class Select(django.forms.Form):
    ...
    sortedasc = django.forms.BooleanField(
...
class View(django.forms.Form):
    ...
    page = django.forms.IntegerField(required=False, initial=1, widget=HIDDENINPUT())
    sortedby = django.forms.CharField(
        required=False, initial="ts", widget=HIDDENINPUT()
    )
    sortedasc = django.forms.BooleanField(
...
class SelectReports(Select):
    ...
    status = django.forms.ChoiceField(
        [models.DEFAULT_ENTRY, ("1", "Error"), ("0", "Done")],
        required=False,
        initial="",
    )
...
class SelectIncoming(Select):
    ...
    statust = django.forms.ChoiceField(
        [models.DEFAULT_ENTRY, ("1", "Error"), ("3", "Done")],
        required=False,
        initial="",
    )
...
class ViewIncoming(View):
    ...
    action = "/incoming/"
    statust = django.forms.IntegerField(
        required=False, initial="", widget=HIDDENINPUT()
    )
    ...
    infilename = django.forms.CharField(
        required=False, widget=HIDDENINPUT(), max_length=256
    )
    lastrun = django.forms.BooleanField(
        required=False, initial=False, widget=HIDDENINPUT()
    )
...
class SelectDocument(Select):
    ...
    status = django.forms.TypedChoiceField(
        [(0, "---------"), (320, _("Document-in")), (330, _("Document-out"))],
        required=False,
        initial=0,
        coerce=int,
    )
...
class SelectOutgoing(Select):
    ...
    action = "/outgoing/"
    statust = django.forms.ChoiceField(
        [models.DEFAULT_ENTRY, ("1", "Error"), ("3", "Done"), ("4", "Resend")],
        required=False,
        initial="",
    )
    idroute = django.forms.ChoiceField([], required=False, initial="")
...
class SelectConfirm(Select):
    ...
    confirmtype = django.forms.ChoiceField(
        models.CONFIRMTYPELIST, required=False, initial="0"
    )
    confirmed = django.forms.ChoiceField(
        [("0", "All runs"), ("1", "Current run"), ("2", "Last run")],
        required=False,
        initial="0",
    )
    idroute = django.forms.ChoiceField([], required=False, initial="")
